...
class ExampleTest extends TestCase
{
    ...
    public function test5RedirectToLoginPageWhenSessionExpired()
    {
        ...
        $m->shouldReceive('getSessionLifetimeInSeconds')->withNoArgs()->andReturn(-60);
        $m->shouldReceive('terminate')->withNoArgs()->andReturn(false);
        $this->app->instance(StartSession::class, $m);
