...
class ExampleTest extends TestCase
{
    ...
    public function test4AllowLoginAfterDelayTime()
    {
        ...
        //$m1 = Mockery::mock(AuthenticatesUsers::class)->shouldAllowMockingProtectedMethods();
        //$m2 = Mockery::mock(ThrottlesLogins::class);//->shouldAllowMockingProtectedMethods();
        $m3 = Mockery::mock(RateLimiter::class);//->shouldAllowMockingProtectedMethods();
        //$m2->shouldReceive('hasTooManyLoginAttempts')->withAnyArgs()->andReturn(false);
        //$m3->shouldReceive('attempts')->withAnyArgs()->andReturn(0);
        $m3->shouldReceive('tooManyAttempts')->withAnyArgs()->andReturn(false);
        //$m2->shouldReceive('maxAttempts')->withAnyArgs()->andReturn(0);
        //$m1->shouldReceive('attemptLogin')->withAnyArgs()->andReturn(true);
        $this->app->instance(RateLimiter::class, $m3);
        //$this->app->instance(ThrottlesLogins::class, $m2);
        //$this->app->instance(AuthenticatesUsers::class, $m1);
