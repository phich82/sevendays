...
class ExampleTest extends TestCase
{
    ...
    public function test2ShowErrorMessageWhenAttemptedLoginOver5Times()
    {
        ...
        $m3 = Mockery::mock(RateLimiter::class);
        $m3->shouldReceive('availableIn')->withAnyArgs()->andReturn(60);
        ...
        //$response->assertSessionHasErrors(['email' => 'Too many login attempts. Please try again in 60 seconds.']);
