...
class ExampleTest extends TestCase
{
    ...
    public function test4AllowLoginAfterDelayTime()
    {
        ...
        $m = Mockery::mock(AuthenticatesUsers::class)->shouldAllowMockingProtectedMethods();
        $m = Mockery::mock(ThrottlesLogins::class)->shouldAllowMockingProtectedMethods();
        $m->shouldReceive('hasTooManyLoginAttempts')->withAnyArgs()->andReturn(false);
        $m->shouldReceive('attemptLogin')->withAnyArgs()->andReturn(true);
