...
class ExampleTest extends TestCase
{
    ...
    public function test2ShowErrorMessageWhenAttemptedLoginOver5Times()
    {
        ...
        $this->post(route('login'), ['email' => 'phich82@gmail.com', 'password' => 'secret'])//;dd(session()->all()->getMessages());
             ->assertSessionHasErrors(['email' => 'Too many login attempts. Please try again in 39 seconds.']);
             //->followRedirects()
