...
class ExampleTest extends TestCase
{
    ...
    {
        $errors = [];
        // try login for 6 times with invalid credentials
        for ($i = 1; $i <= 5; $i++) {
            $this->post(route('login'), ['email' => 'phich82@gmail.com', 'password' => 'xxx'.$i])->assertSessionHasErrors(['email' => 'These credentials do not match our records.']);
