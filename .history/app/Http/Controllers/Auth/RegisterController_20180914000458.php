...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        // create a job and delay 10 minutes
        $job = (new SendMailJob($user))->delay(Carbon::now()->addMinutes(10));
        // push job to queue
        dispatch($job);
        ...
        // monitoring queue: on linux: use 'supervisor' | on windows: use 'forever'
